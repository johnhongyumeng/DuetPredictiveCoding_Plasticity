...
fig_tag='InjCondL23SEDE_'   # Seems 5 for L5, 8 for L23 is good.
coupling_conductance=  80     # Coupling 80 for L23, 10 for L5

#fig_tag='InjCondL5SEDE_'   # Seems 5 for L5, 8 for L23 is good.
...
Num_Injd=11
g_Injd_min=3   # 0.1 nS for the generic VIP model
g_Injd_max=8 
...
TempPlt.myplot(Rate_mat.transpose(),'rate',fig_tag,vmin=0,contour_value=3)
